(function registerViewModel(root, factory) {
  ...
  function buildSideChatViewModel(sideChatListing) {
    ...
    return {
      ...
      modeDescription: "Answers from observable runtime context. Side Chat does not queue Control Chat, set stop flags, change pending actions, or affect planner/Codex flow unless you explicitly promote a message.",
